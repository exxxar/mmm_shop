    ...
    const instagramPostPictureFunction = async () => {
      // await client
        ...
        // .then((res) => {
          ...
          let image_url = "https://upload.wikimedia.org/wikipedia/en/thumb/7/7d/Lenna_%28test_image%29.png/440px-Lenna_%28test_image%29.png";
          let image_name = "test_name"
          Jimp.read(image_url)
            .then((lenna) => {
              return lenna.resize(405, 405, Jimp.RESIZE_NEAREST_NEIGHBOR)
                .quality(100)
                .write(`./${image_name}.jpg`, async () => {
                  // Upload converted and resized JPG to Instagram feed
                  await client
                    .uploadPhoto({
                      photo: `${image_name}.jpg`,
